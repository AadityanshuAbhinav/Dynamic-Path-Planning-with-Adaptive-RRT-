...
class PositionDisplay(Node):
    def __init__(self):
        ...
        self.goal = (WIDTH-50, HEIGHT-50)  # Goal can be static
    ...
    def robot_callback(self, msg):
        self.robot_pos = [
            700 - msg.pose.pose.position.x * SCALE,
    ...
    def publish_path(self, path_points):
        ...
        for (x, y) in path_points:
            ...
            pose.pose.position.x = (700 - x) / SCALE
    ...
    def run(self):
        while rclpy.ok():
            ...
            if self.robot_ready:
                obstacles = [
                    Polygon([(self.actor_pos[0]-20, self.actor_pos[1]-20),
                ...
                rrt = RRTStar(self.robot_pos, self.goal, obstacles)
                path = rrt.find_path()
                if path:
                    self.publish_path(path)

            self.clock.tick(10)  # 10 Hz planning rate
